...
public class CommunityController : ControllerBase
{
        ...
        [FromBody] CreateCommunityDto dto)
    {
        ...
        var result = await _communityService
            .CreateCommunityAsync(dto, userId);
    ...
    public async Task<IActionResult> GetCommunity(Guid communityId)
    {
        ...
        var result = await _communityService
            .GetCommunityAsync(communityId, userId);
    ...
    public async Task<IActionResult> GetAllCommunitiesByMemberAsync()
    {
        ...
        var result = await _communityService
            .GetAllCommunitiesByMemberAsync(userId);
    ...
    public async Task<IActionResult> UpdateCommunity(
        Guid communityId,
        [FromBody] UpdateCommunityDto dto)
    {
        var userId = User.GetUserId();

        var result = await _communityService
            .UpdateCommunityAsync(communityId, dto, userId);
    ...
    public async Task<IActionResult> DeleteCommunity(Guid communityId)
    {
        ...
        var result = await _communityService
            .DeleteCommunityAsync(communityId, userId);
    ...
    public IActionResult GetCommunityLink(Guid communityId)
    {
        ...
        var result = ApiResponse<string>
            .SuccessResponse(link, "Community link generated");
